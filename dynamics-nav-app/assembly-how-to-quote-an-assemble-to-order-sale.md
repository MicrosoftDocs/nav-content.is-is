...
---
# <a name="how-to-quote-an-assemble-to-order-sale"></a>Hvernig á að búa til tilboð með samsetningarpöntun
Hægt er að nota samsetningarstjórnun til að sérsníða samsetningaríhlut eftir beiðni viðskiptavinar á meðan söluferlinu stendur. Frekari upplýsingar, sjá [Hvernig skal: Selja vörur sem eru settar saman í pöntun](assembly-how-to-sell-items-assembled-to-order.md).  
...
2.  Stofna nýja sölupöntunarlínu með eina línu fyrir samsetningaríhlut. Nánari upplýsingar eru í [Hvernig á að gera tilboð](sales-how-make-offers.md).  
...
7.  Ef viðskiptamaðurinn samþykkir tilboðið skal stofna sölupöntun fyrir samsetningaríhlut tilboðsins. Nánari upplýsingar eru í [Hvernig á að gera tilboð](sales-how-make-offers.md). Tengt samsetningartilboð og allar sérstillingar tengjast við þessa nýju sölupöntun til undirbúnings á samsetningu vöru eða vörum sem á að selja.  
