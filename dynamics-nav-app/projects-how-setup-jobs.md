...
1. Uppi í hægra horninu skal velja táknið **Leita að síðu eða skýrslu** slá inn **Uppsetning verka** og velja svo viðeigandi tengil.
...
**Til athugunar**: Setja þarf upp nauðsynlega reikninga í bókhaldslykli áður en bókunarflokkar eru settir upp. Frekari upplýsingar eru í [Setja upp eða breyta bókhaldslykli](finance-setup-setup-chart-accounts.md).  

1. Í efra hægra horni skal velja táknið **Leita að síðu eða skýrslu**, slá inn **Verkbókunarflokkar** og velja síðan viðeigandi tengil.  
