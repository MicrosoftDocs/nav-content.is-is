...
| Forrit | Description |
| --- | --- |
| Microsoft Dynamics NAV | Býður upp á yfirlit með fjárhagslegum lykilupplýsingum yfir tíma, eins og t.d. tekjur á móti útgjöldum, rekstrarframlegð og ferill bundins reiðufés.|
| Microsoft Dynamics 365 for Sales | Býður upp á yfirlit með lykilupplýsingum um sölutækifæri og tengiliði.  |
| Microsoft Dynamics 365 for Sales | Býður upp á yfirlit með lykilupplýsingum um sölutækifæri og tengiliði. |
...
* Aðgang að [!INCLUDE[d365fin](includes/d365fin_md.md)]. Frekari upplýsingar eru í [Dynamics NAV](http://go.microsoft.com/fwlink/?LinkID=759714).  
