...
|Gera virka fjárhagsskýrslugerð fyrir alþjóðleg bókhaldsfyrirtæki með stöðluðu XBRL.|[Hvernig skal: Stofna skýrslur með XBRL](bi-create-reports-with-xbrl.md)|

## <a name="see-also"></a>Sjá einnig
[Fjármál](finance.md)    
[Nota Dynamics NAV sem Power BI gagnaveitu](across-how-use-financials-data-source-powerbi.md)  
