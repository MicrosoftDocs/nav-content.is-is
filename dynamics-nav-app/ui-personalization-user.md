...
---
# <a name="personalizing-your-workspace-using-the-dynamics-nav-web-client"></a>Sérsnídu vinnusvæðið þitt með því að nota vefþjóninn Dynamics NAV vefbiðlarann.
...
1. Í efra hægra horninu skaltu velja ![Stillingar](media/ui-experience/settings_icon_small.png "Stillingar tákn fyrir hlutverkamiðstöð") og velja síðan **Sérstilla**.
    ...
    Borðinn **Sérstillir** birtist efst sem táknar að þú getur byrjað að gera breytingar.
