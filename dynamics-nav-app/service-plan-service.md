...
|Setja upp og sérstilla þjónustuvörur og þjónustuhópa. Í þessu felst að ákveða hvaða hæfni hentar hvaða þjónustu og leiðbeiningar við úrræðaleit.| [Hvernig á að stofna Þjónustuvörur](service-how-to-create-service-items.md)|  
