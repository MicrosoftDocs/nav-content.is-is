...
## <a name="define-a-job-responsibility-code"></a>Skilgreina starfsábyrgðarkóða.
...
1. Í efra hægra horni skal velja táknið **Leita að síðu eða skýrslu**, slá inn **starfsábyrgðir**, og velja síðan viðeigandi tengil.
...
## <a name="assign-job-responsibilities-to-a-contact-person"></a>Úthluta Starfsábyrgðum á tengiliði:
...
fjölda starfsábyrgða sem tengiliðnum hefur verið úthlutað birtist í reitnum **fjöldi starfsábyrgða** í hlutanum**hlutun** í glugganum**tengiliður**.
