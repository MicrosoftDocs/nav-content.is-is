...
|**Til að**|**Sjá**|  
|------------|-------------|  
|Velja kostnaðaraðferð fyrir hverja vöru til að stýra því hvernig upphaflegur kostnaður hennar er notaður til að meta birgðavirði og kostnað seldra vara.|[Hvernig á að Skrá nýjar vörur](inventory-how-register-new-items.md)|  
...
|Setja kerfið þannig upp að leiðrétt sé sjálfvirkt vegna allra kostnaðarbreytinga í hvert sinn sem birgðafærslur eru bókaðar.|[Hvernig á að: Leiðrétta birgðakostnað](inventory-how-adjust-item-costs.md)|  
...
|Skilgreina birgðatímabil til að stýra birgðavirði yfir tiltekinn tíma með því að banna bókun færslna á lokuð birgðatímabil.|[Hvernig á að vinna með birgðatímabil](finance-how-to-work-with-inventory-periods.md)|  
