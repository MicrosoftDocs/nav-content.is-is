...
|Leyfja skilaboð til viðtakanda? | Já |Nr |Nr | Já |
...
4. Í **Greiðslutilvísun** skal slá inn 15 stafa númerið á reikningi lánardrottins. 
    ...
    > [!Tip]
    > Þú verður aðeins að bæta við síðustu 11 tölustöfum í númerinu. Dynamics NAV mun bæta fjórum núllum við upphaf númersins.  
...
[Hvernig á að: Stofna SEPA-innheimtufærslur fyrir beingreiðslur og flytja út í bankaskrá](finance-how-create-sepa-direct-debit-collection-entries-export-bank-file.md)  
