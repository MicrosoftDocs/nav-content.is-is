...
Þessi hluti inniheldur svör við algengum spurningum um nýskráningu og notkun [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)].  
...
Ef spurningar vakna um [!INCLUDE[d365fin](includes/d365fin_md.md)] sem ekki er hægt að finna svar við í þessu skjali er hægt að spyrja Dynamics NAV-samfélagið. Frekari upplýsingar eru í [Dynamics NAV,Business Edition samfélag](https://community.dynamics.com/business). Notendaþjónustan okkar birtir einnig hollráð og ábendingar. Frekari upplýsingar eru í [Dynamics NAV stuðningsblogg](https://blogs.msdn.microsoft.com/dyn365finsupport).  
