...
# <a name="how-to-work-with-the-consolidated-trial-balance-report"></a>Hvernig á að: Vinna með Sameinaða prófjafnaðarskýrslu
Ef þú ert með fleiri en eitt fyrirtæki í [!INCLUDE[d365fin](includes/d365fin_md.md)], getur Sameinuð prófjafnaðarskýrsla í Hlutverkamiðstöð endurskoðanda gefið þér yfirsýn yfir fjárhagslega stöðu fyrirtækja þinna í heild.  
...
4. Á flipanum **Færsluleit**, í flokknum **Gengi**, skal velja **Lokagengi**.  
...
## <a name="to-export-data-from-dynamics-nav-and-import-it-in-included365finincludesd365finmdmd"></a>Til að flytja gögn út úr Dynamics NAV og flytja þau inn í[!INCLUDE[d365fin](includes/d365fin_md.md)]
