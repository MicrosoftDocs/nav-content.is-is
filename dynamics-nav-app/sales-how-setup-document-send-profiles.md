...
# <a name="how-to-set-up-document-sending-profiles"></a>Hvernig á að: Setja upp sendisnið skjala
...
1. Í efra hægra horni skal velja táknið **Leita að síðu eða skýrslu**, slá inn **Sendisnið skjala**, og velja síðan viðeigandi tengil.
...
3. Í reitnum **Sendisnið skjala** skal velja snið sem sett hefur verið upp eftir lýsingum í fyrri skrefum.
