...
## <a name="define-an-organizational-level-code"></a>Skilgreining viðskiptatengslakóða
...
1. Í efra hægra horni skal velja táknið **Leita að síðu eða skýrslu**, slá inn **Stjórnunarstig**, og velja síðan viðeigandi tengil.
...
## <a name="assign-organizational-levels-to-a-contact-person"></a>Úthluta stjórnunarstigum á tengilið
