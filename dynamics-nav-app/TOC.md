...
## [Fáðu Dynamics NAV í farsímann þinn](install-mobile-app.md)
## [Nota Dynamics NAV sem viðskiptainnhólf þitt í Outlook](madeira-outlook.md)
## [Nota Dynamics NAV án Outlook](madeira-no-outlook.md)
...
## [Að láta Dynamics NAV leggja til gildi](ui-let-system-suggest-values.md)
...
### [Hvernig á að: Staðfesta VSK-númer](sales-how-to-verify-vat-registration-numbers.md)
...
## [Merking viðskiptatengsla með Using Dynamics 365 for Sales úr Dynamics NAV](marketing-integrate-dynamicscrm.md)
...
## [Rússland](LocalFunctionality/Russia/russia-local-functionality.md)
